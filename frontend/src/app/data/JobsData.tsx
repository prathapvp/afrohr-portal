...
const dropdownData = [
    { title: "Job Title", icon: IconSearch, options: ['Plant Manager','Accountant','Finance Controller','Production Controller','Quality Analyst','HR Manager','Designer', 'Developer', 'Product Manager', 'Marketing Specialist', 'Data Analyst', 'Sales Executive', 'Content Writer', 'Customer Support'] },
    { title: "Location", icon: IconMapPin, options: ['West Africa','East Africa','Central Africa','Middle East','South East Asia','Delhi', 'New York', 'San Francisco', 'London', 'Berlin', 'Tokyo', 'Sydney', 'Toronto'] },
    { title: "Experience", icon: IconBriefcase, options: ['Entry Level', 'Intermediate', 'Expert','0-2yrs','2-5yrs','5-10yrs','10-15yrs','15+ yrs'] },
