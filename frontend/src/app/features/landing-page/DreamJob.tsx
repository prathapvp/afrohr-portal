...
const DreamJob = () => {
    ...
    return (
        <div className="flex sm-mx:flex-col-reverse items-center px-16 bs-mx:px-10 md-mx:px-5 bg-mine-shaft-950 py-10 bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'url(/page-header-bg.jpg)'}}>
            <div data-aos="zoom-out-right" className="flex flex-col w-[45%] sm-mx:w-full gap-3">
                ...
                <div className="flex gap-3 mt-5 items-center">
                    ...
                    <div className="flex items-center justify-center h-full w-20 text-mine-shaft-100 rounded-lg p-2 hover:bg-bright-sun-500 cursor-pointer">
