...
const ApplyJobComp = (props: any) => {
    ...
    return <div className="mx-auto w-full max-w-6xl">
        <div className="grid gap-6 md:grid-cols-[minmax(250px,320px)_1fr]">
            <aside className="rounded-3xl border border-white/15 bg-[linear-gradient(170deg,rgba(14,23,44,0.9),rgba(9,14,28,0.92))] p-4 shadow-[0_20px_70px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-5 xl:sticky xl:top-24 xl:h-fit">
            ...
            <section className="rounded-3xl border border-white/15 bg-gradient-to-br from-slate-900/85 via-slate-900/70 to-blue-950/60 p-4 shadow-[0_20px_70px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-6">
