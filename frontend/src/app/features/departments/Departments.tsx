...
import { Button, TextInput, Textarea, Loader, Modal } from "@mantine/core";
import { useForm, isNotEmpty } from "@mantine/form";
import { IconEdit, IconTrash, IconPlus, IconBuilding, IconSearch, IconSparkles, IconArrowRight } from "@tabler/icons-react";
import {
    getAllDepartments,
    createDepartment,
    updateDepartment,
...
const Departments = ({ opened, onClose }: DepartmentsProps) => {
    ...
    const form = useForm({
        ...
        validate: {
            name: isNotEmpty("Department name is required"),
        },
    });
    ...
    const handleEdit = (dept: Department) => {
        ...
        form.setValues({ name: dept.name, description: dept.description || "" });
        setShowForm(true);
    };
            ...
            <div className="relative overflow-hidden px-6 pt-6 pb-5">
                ...
                <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-3.5">
                        <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-lg shadow-orange-500/25">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400">Manage your organization&apos;s structure</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                {/* Gradient divider */}
                <div className="mt-5 h-px bg-gradient-to-r from-transparent via-amber-500/30 to-transparent" />
            </div>
            ...
            <div className="px-6 pb-6">
                ...
                <div className="mb-4 flex items-center gap-3">
                    <div className="flex items-center gap-2 rounded-lg border border-white/5 bg-white/[0.03] px-3 py-1.5">
                        ...
                        <span className="text-xs font-medium text-slate-300">{departments.length} Total</span>
                    </div>
                    {search && (
                        <div className="flex items-center gap-2 rounded-lg border border-white/5 bg-white/[0.03] px-3 py-1.5">
                    ...
                    <TextInput
                        ...
                        styles={{
                            input: {
                                ...
                                '&:focus': { borderColor: 'rgba(251,146,60,0.5)' },
                            },
                        }}
                    />
                    <button
                        onClick={() => { resetForm(); setShowForm(true); }}
                        className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-amber-500 via-orange-500 to-pink-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-orange-500/20 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/30 hover:brightness-110"
                    >
                        <IconPlus size={16} /> Add Department
                    </button>
                </div>
                    ...
                    <div className="mb-4 rounded-xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-sm">
                        ...
                        <div className="flex flex-col gap-4">
                            <TextInput
                                ...
                                label={<span className="text-xs font-medium text-slate-300">Department Name</span>}
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    disabled={saving}
                                    className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-orange-500/20 transition-all hover:brightness-110 disabled:opacity-50"
                                >
                ...
                {loading ? (
                    <div className="flex items-center justify-center py-16">
                        <div className="flex flex-col items-center gap-3">
                            ...
                            <span className="text-xs text-slate-500">Loading departments...</span>
                        </div>
                    </div>
                ) : filtered.length === 0 ? (
                    <div className="rounded-xl border border-dashed border-white/10 py-14 text-center">
                        <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5">
                            <IconBuilding className="h-7 w-7 text-slate-600" />
                        </div>
                                        ...
                                        <td className="px-5 py-3.5">
                                            <div className="flex items-center gap-2.5">
                                                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500/10 to-orange-500/10">
                                                    <IconBuilding size={14} className="text-amber-400" />
                                                </div>
