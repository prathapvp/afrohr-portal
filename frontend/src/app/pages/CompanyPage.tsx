...
const CompanyPage = () => {
    ...
    return (
        <div className="relative min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.12),transparent_34%),radial-gradient(circle_at_top_right,rgba(251,191,36,0.12),transparent_34%),linear-gradient(180deg,#060910_0%,#0b1324_58%,#05080f_100%)] font-['poppins'] p-3 sm:p-4">
            ...
            <div className="relative mx-auto w-full max-w-[1400px]">
                ...
                <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
                    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-2.5 shadow-[0_20px_52px_rgba(0,0,0,0.32)]">
                        <Company/>
                    </div>
                    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-2.5 shadow-[0_20px_52px_rgba(0,0,0,0.32)]">
                        <SimilarCompanies/>
